defmodule AdaptiveFold.MixProject do
  use Mix.Project
  ...
  # example compiles its own copy of yieldwise.c / yieldwise_driver.c.
  # Works for both path deps (this repo) and Hex deps (real clients).
  defp make_env do
    yieldwise_dir =
